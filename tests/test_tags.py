...
class TestGetTagsQueryFullFalse:
    ...
    @pytest.mark.positive
    @pytest.mark.status_code
    def test_get_tags_query_full_false_status_code(self, request_get_tags_query_full):
        assert request_get_tags_query_full.status_code == 200, \
            f"Status code {request_get_tags_query_full.status_code} is not 200"

    @pytest.mark.tags
    @pytest.mark.positive
    @pytest.mark.response_body
    def test_get_tags_query_full_false_groups_amount(self, request_get_tags_query_full):
        assert len(request_get_tags_query_full.data) == 2, 'Tags group amount is wrong'
    ...
    @pytest.mark.response_body
    @pytest.mark.parametrize("group_name", tags_groups)
    def test_get_tags_query_full_false_groups_presence(self, request_get_tags_query_full, group_name):
        assert group_name in request_get_tags_query_full.data, f'{group_name} tags group is missing'

    @pytest.mark.tags
    @pytest.mark.positive
    @pytest.mark.response_body
    @pytest.mark.parametrize("group_name, amount", tags_in_group_amount)
    def test_get_tags_query_full_false_in_group_amount(self, request_get_tags_query_full, group_name, amount):
        assert len(request_get_tags_query_full.data[group_name]) == amount, \
    ...
    @pytest.mark.response_body
    @pytest.mark.parametrize("versatile_tag", versatile_tags)
    def test_get_tags_query_full_false_contains_in_versatile(self, request_get_tags_query_full, versatile_tag):
        assert versatile_tag in request_get_tags_query_full.data['versatile'], \
            f'{versatile_tag} tag is not present in versatile group'
    ...
    @pytest.mark.response_body
    @pytest.mark.parametrize("nsfw_tag", nsfw_tags)
    def test_get_tags_query_full_false_contains_in_nsfw(self, request_get_tags_query_full, nsfw_tag):
        assert nsfw_tag in request_get_tags_query_full.data['nsfw'], \
...
class TestGetTagsQueryFullTrue:
    ...
    @pytest.mark.positive
    @pytest.mark.status_code
    def test_get_tags_query_full_true_status_code(self, request_get_tags_query_full):
        assert request_get_tags_query_full.status_code == 200, \
            f'Status code {request_get_tags_query_full.status_code} is not 200'
    ...
    @pytest.mark.positive
    @pytest.mark.response_body
    def test_get_tags_query_full_true_groups_amount(self, request_get_tags_query_full):
        assert len(request_get_tags_query_full.data) == 2, 'Tags group amount is wrong'
    ...
    @pytest.mark.response_body
    @pytest.mark.parametrize("group_name", tags_groups)
    def test_get_tags_query_full_true_groups_presence(self, request_get_tags_query_full, group_name):
        assert group_name in request_get_tags_query_full.data, f'{group_name} is not present'

    @pytest.mark.tags
    @pytest.mark.positive
    @pytest.mark.response_body
    @pytest.mark.parametrize("group_tag, amount", tags_in_group_amount)
    def test_get_tags_query_full_true_amount_of_tags_in_group(self, request_get_tags_query_full, group_tag, amount):
        assert len(request_get_tags_query_full.data[group_tag]) == amount, f'Amount of {group_tag} tags is not {amount}'

    @pytest.mark.tags
    @pytest.mark.positive
    @pytest.mark.response_body
    @pytest.mark.parametrize("tag_full_info", tags_full_info)
    def test_get_tags_query_full_true_tags_info_size(self, tag_full_info, request_get_tags_query_full):
        assert len(tag_full_info_provider(request_get_tags_query_full.data, tag_full_info)) == 4, \
    ...
    def test_get_tags_query_full_true_contains_info_description(self,
                                                                request_get_tags_query_full, tag_name, tag_description):
        assert (tag_full_info_description_provider(request_get_tags_query_full.data, tag_name) == tag_description), \
    ...
    def test_get_tags_query_full_true_contains_info_id(self, request_get_tags_query_full, tag_name, tag_id):
        assert tag_full_info_id_provider(request_get_tags_query_full.data, tag_name) == tag_id, \
    ...
    def test_get_tags_query_full_true_contains_info_is_nsfw_state(self,
                                                                  request_get_tags_query_full, tag_name, is_nsfw_state):
        assert (tag_full_info_is_nsfw_state_provider(request_get_tags_query_full.data, tag_name) ==
    ...
    @pytest.mark.response_body
    @pytest.mark.parametrize("tag_full_info", tags_full_info)
    def test_get_tags_query_full_true_contains_info(self, tag_full_info, request_get_tags_query_full):
        assert tag_full_info_comparer(request_get_tags_query_full.data, tag_full_info), \
